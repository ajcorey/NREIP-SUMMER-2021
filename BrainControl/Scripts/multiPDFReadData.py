...
try:
    ...
    plt.plot(x, y1)
    plt.savefig((pdfFilename + '_Channel_1.pdf'), dpi = 1200)
    ...
    frame1.axes.get_xaxis().set_visible(False)
    plt.plot(x, y2)
    plt.savefig((pdfFilename + '_Channel_2.pdf'), dpi = 1200)
    ...
    frame1.axes.get_xaxis().set_visible(False)
    plt.plot(x, y3)
    plt.savefig((pdfFilename + '_Channel_3.pdf'), dpi = 1200)
    ...
    frame1.axes.get_xaxis().set_visible(False)
    plt.plot(x, y4)
    plt.savefig((pdfFilename + '_Channel_4.pdf'), dpi = 1200)
    ...
    frame1.axes.get_xaxis().set_visible(False)
    plt.plot(x, y5)
    plt.savefig((pdfFilename + '_Channel_5.pdf'), dpi = 1200)
    ...
    frame1.axes.get_xaxis().set_visible(False)
    plt.plot(x, y6)
    plt.savefig((pdfFilename + '_Channel_6.pdf'), dpi = 1200)
